...
public class DemoConsumer {
  ...
  public static void main(String[] args) {
     args = new String[]{"192.168.99.100:2181", "test1", "group1", "consumer1"};
...
//      String message = String.format("Consumer ID:%s, Topic:%s, GroupID:%s, PartitionID:%s, Offset:%s, Message Key:%s, Message Payload: %s",
//              consumerid,
...
//              messageAndMetadata.offset(), new String(messageAndMetadata.key()),new String(messageAndMetadata.message()));
      String message = new String(it1.next().message());
